...
var import_node_path, protoLoader, grpc, fs, protoDir, protoFiles, packageDefinition, paymentProto, userProto, serviceGRPC, userClient;
var init_grpc_service = __esm({
  "src/common/infrastructure/grpc.service.ts"() {
    "use strict";
    import_node_path = __toESM(require("path"));
    protoLoader = __toESM(require("@grpc/proto-loader"));
    grpc = __toESM(require("@grpc/grpc-js"));
    fs = __toESM(require("fs"));
    protoDir = import_node_path.default.join("src/data/proto");
    protoFiles = fs.readdirSync(protoDir).filter((file) => file.endsWith(".proto")).map((file) => import_node_path.default.join(protoDir, file));
    packageDefinition = protoLoader.loadSync(protoFiles, {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
    ...
    paymentProto = grpc.loadPackageDefinition(packageDefinition);
    ...
    userClient = new userProto.UserProto.UserService("localhost:8000", grpc.credentials.createInsecure());
  }
});
...
var init_generic_controller = __esm({
  "src/common/infrastructure/generic.controller.ts"() {
    "use strict";
    init_http_status();
...
var import_typeorm, GenericSA;
var init_generic_sa = __esm({
  "src/common/service/generic.sa.ts"() {
    "use strict";
    ...
    GenericSA = class {
      ...
      async updateMany(ids) {
        return await (0, import_typeorm.getRepository)(this.name).createQueryBuilder().update().set({ isdelete: 1 }).where("id IN (:...ids)", { ids }).execute();
      }
      async updateAll(where) {
        return await (0, import_typeorm.getRepository)(this.name).createQueryBuilder().update().set({ isdelete: 1 }).where(where ?? {}).execute();
      }
      async findById(id) {
        try {
...
var import_typeorm2, Base;
var init_base_do = __esm({
  "src/data/do/base.do.ts"() {
    "use strict";
    ...
    __decorateClass([
      (0, import_typeorm2.CreateDateColumn)({ type: "timestamp" })
    ], Base.prototype, "createdAt", 2);
    __decorateClass([
      (0, import_typeorm2.UpdateDateColumn)({ type: "timestamp" })
    ], Base.prototype, "updatedAt", 2);
  }
});

// src/data/do/payment.do.ts
var import_typeorm3, Payment;
var init_payment_do = __esm({
  "src/data/do/payment.do.ts"() {
    "use strict";
    import_typeorm3 = require("typeorm");
    init_base_do();
    Payment = class extends Base {
      userId;
      amount;
    };
    __decorateClass([
...
var import_dotenv, import_envalid, configs;
var init_configs = __esm({
  "src/data/constants/configs.ts"() {
    ...
    configs = (0, import_envalid.cleanEnv)(process.env, {
      NODE_ENV: (0, import_envalid.str)({ default: "development", choices: ["development", "production", "test"] }),
      HOST: (0, import_envalid.host)({ default: "localhost" }),
      REST_PORT: (0, import_envalid.port)({ default: 4001 }),
      GRPC_PORT: (0, import_envalid.port)({ default: 8001 }),
      CORS_ORIGIN: (0, import_envalid.str)({ default: "http://localhost:3000" }),
      COMMON_RATE_LIMIT_MAX_REQUESTS: (0, import_envalid.num)({ default: 1e3 }),
      COMMON_RATE_LIMIT_WINDOW_MS: (0, import_envalid.num)({ default: 1e3 }),
      DB_TYPE: (0, import_envalid.str)({ default: "postgres" }),
      DB_HOST: (0, import_envalid.host)({ default: "localhost" }),
      DB_PORT: (0, import_envalid.port)({ default: 5432 }),
      DB_USER: (0, import_envalid.str)({ default: "postgres" }),
      DB_PASS: (0, import_envalid.str)({ default: "" }),
      DB_NAME: (0, import_envalid.str)({ default: "" }),
      JWT_EXPIRATION: (0, import_envalid.str)({ default: "3600s" }),
      JWT_REFRESH_TOKEN_EXPIRATION: (0, import_envalid.str)({ default: "3600s" }),
      JWT_SECRET: (0, import_envalid.str)({ default: "" }),
      PWD_RESET_EXPIRATION: (0, import_envalid.str)({ default: "3600s" }),
      PWD_RESET_SECRET: (0, import_envalid.str)({ default: "" })
    });
  }
});

// src/data-source.ts
var import_reflect_metadata, import_typeorm4, DB_HOST, DB_NAME, DB_PORT, DB_PASS, DB_USER, DB_TYPE, NODE_ENV, AppDataSource;
var init_data_source = __esm({
  "src/data-source.ts"() {
    "use strict";
    import_reflect_metadata = require("reflect-metadata");
    import_typeorm4 = require("typeorm");
    init_payment_do();
    init_configs();
    ({ DB_HOST, DB_NAME, DB_PORT, DB_PASS, DB_USER, DB_TYPE, NODE_ENV } = configs);
    AppDataSource = new import_typeorm4.DataSource({
      type: DB_TYPE,
      host: DB_HOST,
      port: DB_PORT,
      username: DB_USER,
...
var init_exception_handler = __esm({
  "src/service/middleware/exception-handler.ts"() {
    "use strict";
    init_http_status();
...
var import_typeorm5, GenericSM;
var init_generic_sm = __esm({
  "src/common/service/generic.sm.ts"() {
    "use strict";
    import_typeorm5 = require("typeorm");
    init_http_status();
      ...
      async deleteMany(ids) {
        try {
          const entities = await this.repository.find({
            where: { id: (0, import_typeorm5.In)(ids) }
          });
          if (!entities.length) {
...
var PaymentSM, paymentSM;
var init_payment_sm = __esm({
  "src/service/metier/payment.sm.ts"() {
    "use strict";
    init_data_source();
    init_generic_sm();
    init_payment_do();
    PaymentSM = class extends GenericSM {
    };
    paymentSM = new PaymentSM(AppDataSource.getRepository(Payment));
  }
});

// src/common/constraint/factory/generic.factory.ts
var import_morphism, GenericFactory;
var init_generic_factory = __esm({
  "src/common/constraint/factory/generic.factory.ts"() {
    "use strict";
    import_morphism = require("morphism");
    GenericFactory = class {
      constructor(targetDoSchema, targetRequestDtoSchema, targetResponseDtoSchema) {
        ...
        this.mapper = import_morphism.morphism;
      }
      mapper;
      toRequestDto(source) {
...
var commonSchema, responseSchema, PaymentFactory, paymentFactory;
var init_payment_factory = __esm({
  "src/constraint/factory/payment.factory.ts"() {
    "use strict";
    init_generic_factory();
    commonSchema = {
      userId: "userId",
      amount: "amount"
    };
    ...
    PaymentFactory = class extends GenericFactory {
    };
    paymentFactory = new PaymentFactory(commonSchema, commonSchema, responseSchema);
  }
});

// src/service/applicatif/payment.sa.ts
var PaymentSA, paymentSA;
var init_payment_sa = __esm({
  "src/service/applicatif/payment.sa.ts"() {
    "use strict";
    init_generic_sa();
    init_payment_sm();
    init_payment_factory();
    init_grpc_service();
    PaymentSA = class extends GenericSA {
    ...
    paymentSA = new PaymentSA(paymentSM, paymentFactory, "payment");
  }
});
...
var init_payment_controller = __esm({
  "src/infrastructure/controller/payment.controller.ts"() {
    "use strict";
    init_generic_controller();
    init_payment_sa();
    init_http_status();
    PaymentController = class extends GenericController {
    ...
    paymentController = new PaymentController(paymentSA);
  }
});
...
var import_express, paymentRoutes, paymentRouter;
var init_payment_route = __esm({
  "src/infrastructure/route/payment.route.ts"() {
    ...
    paymentRouter = paymentRoutes();
  }
});

// src/infrastructure/route/app.route.ts
var app_route_exports = {};
__export(app_route_exports, {
  appRouter: () => appRouter
});
var import_express2, appRoutes, appRouter;
var init_app_route = __esm({
  "src/infrastructure/route/app.route.ts"() {
    "use strict";
...
// src/service/middleware/grpc.ts
var grpc2 = __toESM(require("@grpc/grpc-js"));
init_grpc_service();

// src/infrastructure/grpc/payment/payment.grpc.ts
init_payment_controller();

// src/common/utils/error-handler.ts
var grpcValue = __toESM(require("@grpc/grpc-js"));
var handleGrpcError = (callback, error, code = grpcValue.status.INTERNAL) => {
  callback(
    {
      code,
...
// src/infrastructure/grpc/payment/payment.grpc.ts
var makePayment = async (call, callback) => {
  try {
...
// src/service/middleware/grpc.ts
var serverGrpc = new grpc2.Server();
serverGrpc.addService(serviceGRPC.paymentService, {
  makePayment
});
var grpc_default = serverGrpc;
...
// src/service/middleware/database.ts
init_data_source();
...
// src/service/middleware/response-formatter.ts
init_http_status();
var responseFormatter = (req, res) => {
  const { statusCode = HttpStatus.OK, data, message = "" } = res.locals;
  res.status(data !== void 0 && statusCode === HttpStatus.BAD_REQUEST ? HttpStatus.OK : statusCode).json({ message, data, isError: false });
};
...
var responseBodyMiddleware = (_req, res, next) => {
  const isNotProduction = !configs.isProduction;
  if (isNotProduction) {
...
// src/app.ts
var { REST_PORT } = configs;
var app = (0, import_express3.default)();
var App = class {
  initMiddlewares = async () => {
  ...
  initRoutes = async () => {
    ...
    const { appRouter: appRouter2 } = await Promise.resolve().then(() => (init_app_route(), app_route_exports));
    app.use("/api", appRouter2, responseFormatter);
...
// src/index.ts
var bootstrapAsync = async () => {
  const { GRPC_PORT } = configs;
  try {
    await app_default.init();
    grpc_default.bindAsync(`localhost:${GRPC_PORT}`, grpc3.ServerCredentials.createInsecure(), (err, port2) => {
      if (err) {
        logger.error(err);
        return;
      }
      logger.info(`GRPC Server listening on port ${port2}`);
    });
  } catch (error) {
    console.log(error);
  }
