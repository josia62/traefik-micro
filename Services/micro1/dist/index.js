...
var import_bcryptjs, import_typeorm3, User;
var init_user_do = __esm({
  "src/data/do/user.do.ts"() {
    "use strict";
    ...
    __decorateClass([
      (0, import_typeorm3.Column)("varchar", { nullable: true, default: "" })
...
var init_configs = __esm({
  "src/data/constants/configs.ts"() {
    ...
    configs = (0, import_envalid.cleanEnv)(process.env, {
      ...
      REST_PORT: (0, import_envalid.port)({ default: 4e3 }),
      GRPC_PORT: (0, import_envalid.port)({ default: 8e3 }),
...
var UserSM, userSM;
var init_user_sm = __esm({
  "src/service/metier/user.sm.ts"() {
    "use strict";
    init_data_source();
    init_generic_sm();
    init_user_do();
    UserSM = class extends GenericSM {
    };
    userSM = new UserSM(AppDataSource.getRepository(User));
  }
});
...
var commonSchema, schema, responseSchema, UserFactory, userFactory;
var init_user_factory = __esm({
  "src/constraint/factory/user.factory.ts"() {
    "use strict";
    ...
    UserFactory = class extends GenericFactory {
    };
    userFactory = new UserFactory(schema, schema, responseSchema);
  }
});

// src/service/applicatif/user.sa.ts
var UserSA, userSA;
var init_user_sa = __esm({
  "src/service/applicatif/user.sa.ts"() {
    "use strict";
    init_generic_sa();
    init_user_sm();
    init_user_factory();
    UserSA = class extends GenericSA {
      async getUserById(userId) {
        return this.serviceSM.findOne({ id: userId });
      }
    };
    userSA = new UserSA(userSM, userFactory, "user");
  }
});
...
var init_user_controller = __esm({
  "src/infrastructure/controller/user.controller.ts"() {
    ...
    init_user_sa();
    init_http_status();
    UserController = class extends GenericController {
    ...
    userController = new UserController(userSA);
  }
});
...
var import_express, userRoutes, userRouter;
...
var protoDir = import_node_path.default.join("src/data/proto");
var protoFiles = fs.readdirSync(protoDir).filter((file) => file.endsWith(".proto")).map((file) => import_node_path.default.join(protoDir, file));
...
// src/infrastructure/grpc/degree/user.grpc.ts
init_user_controller();
var import_empty_pb = require("google-protobuf/google/protobuf/empty_pb");
var getUserById = async (call, callback) => {
  const userId = call?.request?.id || "";
  const response = await userController.getUserById(userId);
  callback(null, response);
};
var createUser = async (call, callback) => {
  await userController.createUser(call.request);
  callback(null, new import_empty_pb.Empty());
};
